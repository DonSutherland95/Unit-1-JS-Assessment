...
function getVehiclesCostInCreditsSumTotal(character) {
  // return (
  //   character.vehicles[0].cost_in_credits +
  //   character.vehicles[1].cost_in_credits
  // );
  // let cars = character.filter((item) => {
  //   return item.vehicles;
  // });
  // console.log(cars);
  // let total = 0;
  // total = character.reduce((acc, item) => {
  //   return (
  //     acc + item.v
  //   );
  // });
...
function getStarshipPassengerAndCrewSumTotal(character) {
  // let total = 0;
  // total = character.reduce((acc, item) => {
  //   return acc + item.starships.crew + item.starships.passenger;
  // }, 0);
  let sum = 0;
